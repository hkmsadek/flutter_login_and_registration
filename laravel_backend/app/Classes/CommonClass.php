...
class CommonClass {
    ...
    public function singleDivData($id){
        $rank=[];
    ...
    public function tournamentName($id){
        return Tournament::where('id', $id)->first(['tournamentName']);
    }
    public function getMatches($id){
        return Fixtureandresult::where('division_id', $id)->orderBy('round', 'asc')
        ->with(['date'=> function($q){
           $q->select('id', 'gameLength','startingDate','startingTime','weekday') ;
        }])
        ->with(['home'=> function($q){
